...
| Manual estimating E1 | Bounded implementation is merged; current-main E1 assurance passed. E2 is prepared only. | [E1 handover](delivery/estimating-e1-handover.md), [E2 starter](delivery/estimating-e2-starter.md), [current-main E1 run](https://github.com/deanrfiedler-gif/powerplants-one/actions/runs/34310303868). Full BP-04/rule evidence and acceptance remain open. |
...
| Quotation Builder | Template-first design is open in PR #77; no implementation or merge is claimed here. | [PR #77](https://github.com/deanrfiedler-gif/powerplants-one/pull/77). Follow its design review and synthetic evidence. |
...
[Repository housekeeping](delivery/repository-housekeeping.md) records the authorised documentation cleanup, 27 audited merged-branch candidates and open-PR dispositions. CI optimisation and runtime changes remain separate work.
