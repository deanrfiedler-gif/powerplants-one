...
## PPO Assistant AI1 implementation — 8 September 2026

Dean explicitly authorised the first working synthetic journey with a clearly labelled simulated assistant. [Issue #66](https://github.com/deanrfiedler-gif/powerplants-one/issues/66), the [AI1 decision](decisions/assistant-ai1-implementation.md) and [handover](delivery/assistant-ai1-handover.md) govern customer search, bounded source-linked CRM context, reviewed canonical opportunity/initial Activity creation, durable recovery and exact verification/publication. This is a review-branch implementation with the default mode off; real-provider selection, account and budget remain open. It uses a responsive full page; the contextual drawer is a later refinement. Migration 0016 preserves #64’s independent 0015 reservation. No full AIA, owner, independent-review or production acceptance follows from authored or component tests.
