...
| Documentation checks | `check_foundation`, `check_prototype`, `check_naming` pass at `cb358405` (78 parents, 29 decisions, 30 PT procedures, 12 packages, 114 document records) | Local run, 11 September 2026 |
