# Project acceptance & closeout · outstanding — design reference

Stable entry: `route:/projects/acceptance/outstanding`. Owner: Dean Fiedler. Status: **Draft for visual review**.
Source baseline: `ccc2251bbba9df266cac9027ddaa9418ab9abc1d`. Application destination: `/projects/acceptance/outstanding`.
...
1. Review open items for the selected project/stage.
2. Confirm each item has a source, responsible owner, next action and truthful due state.
3. Resolve through the owning workflow and check whether the acceptance/closeout evidence now reflects the result.
