...
Source baseline: `ccc2251bbba9df266cac9027ddaa9418ab9abc1d`. Application destination: `/estimating/discovery/{id}`.
...
2. Review Requirements, Configuration, Scope & delivery, Pricing and Review
3. Keep alternatives and their exact revisions distinct
4. Check the saved cost basis before preparing a quotation
