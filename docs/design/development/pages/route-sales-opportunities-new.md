...
4. Then continue the wider workflow: Maintain the next action and record stage changes through available controls
...
The draft User Guide `guide.page.sales.opportunities.new` carries prerequisites, tasks, outcomes and recovery. Review that article against the running release before publication. Keep source presence, visual review, functional testing, owner acceptance and deployment separate.
