# Stakeholders & relationships — native receiving reference

Stable entry: `scope:CS-03`. Scope: **CS-03**. Owner: Dean Fiedler.
Source main: `25170bf83008727f005e36b5603841a7b9359027`. Route: `/customers/[id]/stakeholders`.
...
Review customer relationships using canonical affiliations, Site parties and primary contacts.

r20 page type: **Record detail; Review / comparison**. Current relationships, Historic relationships and Site parties / contact gaps.
...
Recorded role is not authority to commit the customer. Authority basis distinguishes Recorded, Asserted by us and Unknown; canonical rows are only Recorded. No purchasing authority, stakeholder master or duplicate relationship store is created. Restricted does not mean no contact recorded.
...
The detailed page guide is `guide.cs.03`. [CS receiving handover](../../../delivery/cs-native-completion-handover.md) records executed behaviour, visual inspection, source hashes and open business definitions. Owner/device acceptance and deployment remain separate.
