# Sales-to-estimating handover record — design contract

<!-- versioning: git; committed history is authoritative -->

Stable entry: `route:/sales/handoffs/estimating/[id]`. Owner: Dean Fiedler. Review: pending. Parent scope: CR-02. Route: `/sales/handoffs/estimating/[id]`.
...
Loading, empty/filter-empty, partial, failed, denied, read-only, validation, saving, saved, uncertain and source-changed states remain explicit. The guide `guide.route-sales-handoffs-estimating-id` carries normal and recovery steps.
