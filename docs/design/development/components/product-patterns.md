...
**Owner:** Dean Fiedler · **Catalogue key:** `product-patterns` · **Review:** Pending

Retained product patterns need a bounded application-component inventory and fixture before claiming runnable coverage.

## Source and reference

Design: [powerplants-one-theme-style-board-r22.html](../../../reference/ui/theme-style-board/powerplants-one-theme-style-board-r22.html#products). Reference only; proposed pattern.
