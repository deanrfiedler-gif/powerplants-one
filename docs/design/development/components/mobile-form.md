...
**Owner:** Dean Fiedler · **Catalogue key:** `mobile-form` · **Review:** Pending

The same runtime fields and validation with a long-title phone fixture.

## Source and reference

Design: [powerplants-one-theme-style-board-r22.html](../../../reference/ui/theme-style-board/powerplants-one-theme-style-board-r22.html#responsive). Retained design reference; paired acceptance not recorded.
...
Use the phone presets and a separate browser window. This is the same form component family at a real responsive viewport.

## Mobile

Check 390/320 px, 200% zoom, touch targets, keyboard occlusion and error focus. No scaled screenshot is used.
...
Real-device input, screen-reader and keyboard-occlusion acceptance remain pending.
