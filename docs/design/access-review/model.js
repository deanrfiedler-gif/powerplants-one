(function(root){
  ...
  const LABELS={
    'supply.read': 'Read Supply Chain coordination',
    'supply.coordinate': 'Coordinate Supply Chain demand and sources',
    'supply.inspect': 'Record Supply Chain receipt inspections',
    ...
    'engineering.technical.review':'Review exact Engineering content',
    'engineering.technical.issue':'Issue reviewed Engineering outputs',
    'engineering.technical.distribute':'Record Engineering distribution evidence',
    'engineering.technical.source':'Read restricted Engineering sources',
