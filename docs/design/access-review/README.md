# Users, Roles, Teams & Access Review source (AD-01 r01)

This source produces the [standalone r01 HTML](../../reference/ui/access-review/PPO-Users-Roles-and-Access-Review-r01.html). The [companion report](../../reference/ui/access-review/PPO-Users-Roles-and-Access-Review-Report-r01.md) documents its views, fields, rules, provenance and receiving boundaries. The [build plan](../../delivery/users-roles-access-review-build-plan.md) records the intended scope.
...
| `capabilities.js` | **Generated. Do not edit.** The 70-value `Capability` union from `src/platform/permissions.ts` and the 31-value hosted tester set from `scripts/demo-database.ts`, with the SHA-256 of both sources. |
