...
| `capabilities.js` | **Generated. Do not edit.** The 61-value `Capability` union from `src/platform/permissions.ts` and the 31-value hosted tester set from `scripts/demo-database.ts`, with the SHA-256 of both sources. |
