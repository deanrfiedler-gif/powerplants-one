...
3. Implement work packages P01–P12 in dependency order. P01/P02 are complete; P03 delivery and component evidence are recorded in its handover and P04 is the next bounded task. Existing PPO issues remain discovery/design records; they are not silently converted into application tasks.
