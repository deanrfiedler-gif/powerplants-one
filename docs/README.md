...
| PPO Assistant | [Pilot specification](blueprints/ppo-assistant-specification.md), [AI1 implementation decision](decisions/assistant-ai1-implementation.md), [AI1 handover](delivery/assistant-ai1-handover.md); simulated journey on review branch, real-model evaluation pending |
