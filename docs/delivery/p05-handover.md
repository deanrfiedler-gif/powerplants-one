...
**Publication:** [issue #28](https://github.com/deanrfiedler-gif/powerplants-one/issues/28) · [PR #29](https://github.com/deanrfiedler-gif/powerplants-one/pull/29) · branch `feature/p05-planner-controlled-changes`. Component verification is complete. The [publication record](https://github.com/deanrfiedler-gif/powerplants-one/issues/28#issuecomment-5551471867) records the actual final head/tree, merge SHA/tree, merged-main checks and review state; this document does not predict a future merge result.
...
Final layout run [33962234250](https://github.com/deanrfiedler-gif/powerplants-one/actions/runs/33962234250), PR source `97bf2c227587726e06d96ae671d2531c9004bdbf`, tree `becdd7fbdac1f1badd102c428d3da1ef752a32d2`, passed **5 unit, 65 PostgreSQL, 8 HTTP and 28 Chromium** cases (106 component cases), including fresh/upgrade/repeat seed/reset and actual PostgreSQL restart. CI executed PR merge ref `288734b24f545ede288223b575ad78326e65a913` with the identical tree; documentation run **33962234216** passed all three checks. The final publication commit adds evidence/documentation only; exact-head and merged-main runs belong in the linked publication record.

All **42 original P05 screenshots** from artifact **9968406800** were manually inspected through full-page overviews and readable critical regions. [Visual index](../testing/evidence/p05/README.md) and [manifest](../testing/evidence/p05/manifest.json) preserve original paths/dimensions/PNG hashes, source/executed tree and archive hash `004f9828baa99c8e98f5fa6132e5ff0d0d3020a8a9cef68afb633781131eba02`. Chrome Headless Shell **153.0.8010.12** (Playwright build **1243**) used desktop **1440×1000** and phone **390×844**, locale en-AU. No blocking overlap/page clipping was found. Phone week lanes scroll within labelled focusable regions; long forms/modal contents scroll vertically. Native dates and long single-line inputs retain browser-specific display behaviour. No additional runtime defect was found during final self-review.
...
Before merge recheck exact head/tree, required status/review/thread conditions, private visibility and unchanged main. Record final source, merge SHA/tree and merged-main check results in issue #28's final publication comment to avoid a document claiming its own future commit hash. The pre-publication recheck reported main unprotected with no required contexts, no submitted PR reviews and no unresolved review threads. Detailed branch protection returned integration 403; rulesets returned account-entitlement 403 and the per-branch rules URL was unsupported. These read limitations are recorded, not bypassed; normal GitHub merge still enforces active rules. No setting was changed or bypassed. Final observed review/merge state belongs in the linked publication record. No independent review was submitted at the finalisation inspection.
