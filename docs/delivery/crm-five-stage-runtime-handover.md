...
The first compiled cutover run `34780675376` recorded 152 passed, two failed and three explicitly skipped cases. Both failures were the same real detail-form defect: after an accepted stage dialog, the clean next-action form retained the old expected version. Its original archive `10325451217` is 117,369,930 bytes / SHA-256 `c17e3fe1d85e519a2cb215e4842aff545b8505a4d931ba4c698aa673af87fb24`; ZIP integrity, failure contexts and original screenshots were inspected. A clean sibling form now advances from that exact accepted stage receipt. Independently edited proposals retain their old version and explicit comparison; a new desktop/phone regression asserts this distinction. Stage controls remain disabled during a pending or uncertain sibling command.

Persisted five-stage source `fd5a9ae` passed nine focused DB cases, eleven CRM browser cases (two explicit phone drag skips), thirteen retained I2 cases and the CRM restart proof. Artifact `10324569683`, 4,441,736 bytes, SHA-256 `5a38c1ec8ba91793643955728fdd292628615a833dcc8da2a74b8a1b0355ed07`, passed ZIP/hash checks; original five-stage desktop/390/320 captures were inspected. At 320 px the long stage label crowded its button, and the phone confirmation area left the returned focus target below the useful visible region. Labels now wrap within their control and focus return explicitly centres the moved card action. The keyboard regressions require the focused control to be fully in the viewport; new captures remain required.
