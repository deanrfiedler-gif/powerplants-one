...
**Document ID:** PPO-DEMO-RUNTIME · **Revision:** r01 · **Date:** 9 September 2026 · **Owner:** Dean Fiedler · **State:** Prepared implementation; cloud deployment and invited-user acceptance not executed.
...
```bash
python3 infra/azure-demo/operator.py configure ../ppo-demo-settings.local.json
python3 infra/azure-demo/operator.py plan ../ppo-demo-settings.local.json
```
...
```bash
python3 infra/azure-demo/operator.py provision ../ppo-demo-settings.local.json
```
...
```bash
python3 infra/azure-demo/operator.py bootstrap ../ppo-demo-settings.local.json
```
...
```bash
python3 infra/azure-demo/operator.py testers ../ppo-demo-settings.local.json
```
