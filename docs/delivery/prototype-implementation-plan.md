...
**Edition:** r12 · **Status:** P01/P02 complete; P03 implemented with final component and publication evidence in its [handover](p03-handover.md); P04 component-verified with evidence in its [handover](p04-handover.md); P05 implemented with final verification/publication in its [handover](p05-handover.md); P06 implemented with exact verification/publication in its [handover](p06-handover.md); P07 implemented with exact verification/publication in its [handover](p07-handover.md); P08 implemented with verification/publication evidence in its [handover](p08-handover.md); P09 implemented with exact verification/publication in its [handover](p09-handover.md); P10 separately authorised and implemented; exact final verification/publication governed by its handover and external record; P11 implemented with exact final verification/publication governed by its handover and external record; P12 implementation and isolated verification in progress under #165/#166. Full-procedure execution is recorded separately from the authored catalogue defaults.
...
P11 has been invoked under [issue #54](https://github.com/deanrfiedler-gif/powerplants-one/issues/54). Its [handover](p11-handover.md) governs current checkpoint scope, approved ADR-0018 Travel treatment and actual verification/publication. P11 bounded source/main publication is complete. P12 is invoked under [#165](https://github.com/deanrfiedler-gif/powerplants-one/issues/165), with the [handover](p12-handover.md) and [runbook](p12-recovery-runbook.md) governing its implementation, exact evidence and remaining full-procedure/owner acceptance. The ordered P11/P12 completion boundaries remain unchanged.
