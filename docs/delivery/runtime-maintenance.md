...
Further visual review on source `41d6da7f9682391f750439b09cb78f6dbd306d15` inspected all pages of the eight-page E1 long quotation (artifact `10328377460`, run `34791071045`) and six-page successor job pack, five-page reserved report and three-page long revised report (artifact `10327963438`, run `34791071026`). Tables, totals, long-text reflow, headers and footers remained intact, with no observed clipping or overlap. E1's write/recover/verify phases retained the same PDF hash `c0b4cb8f44ff524647e5c00d52f178c17bbe5ab13d4c9c2a3e38fc7f480b2bc1` and HTML hash `725d5f2f71513842cf4af0022841fe9cb67687bec397674b1b2fb8a7a23fa232` through actual application and PostgreSQL restarts. These are representative maintenance checks, not new business acceptance.

While the final CI was running, #158 merged to `main` as `d069ea3e0a0e82034bb47e501e1c293d12933cd2`. The maintenance branch incorporates that main commit and preserves all of its CRM code, migration 0023, tests and adopted policy package. The two textual conflicts were the current-session status row and appended document-register entries; both work packages remain recorded. The combined CRM restart proof retains the newer Won/Lost assertions and the patched Chrome channel. Final checks must run again on this combined tree. The maintenance diff relative to current main still adds no migration; pulling unrelated CRM work may require its own migration instructions.
