...
The later concurrent PR #286 (component catalogue) remained open at the final reconciliation checkpoint, head `00c7e52a` (previously inspected at `b30df175`). Its published file list overlaps the shell, development register/guides and AGENTS guidance. No unfinished code was copied. After PR #285 passed every check and merged externally, main was fetched again at `4c8fd6dba83794f6c64aee6859cadb913401fd64`, tree `b6bfad22214ab0ce13216011242cea3b77730beb`. Native reconciliation commit `2165546cd29a37098dfb665caf30d77d8b805b81` merges that main with no implementation changes or conflicts. Both main and final merged #284 are ancestors of the CS head. The migration registry remains through 0044; no shell, saved-view, notification or guide contribution is lost. A later merged contribution must still be reconciled before merge.
