...
| [Screen specification](../blueprints/crm-screen-specification.md) and [standalone wireframes](../blueprints/crm-wireframes.html) and [18 original captures](https://github.com/deanrfiedler-gif/powerplants-one/blob/3f347fa5ffabb4bda4c684c7f2edb1c5fe5f5d65/docs/blueprints/crm-visuals/README.md) | Seven synthetic desktop/phone screens, board/list alternative and seven illustrative states; no app integration or persistence |
