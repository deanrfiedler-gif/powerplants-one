...
**Date:** 7 September 2026 · **Owner:** Dean Fiedler · **State:** Proposed screen contract; no application controls implemented. **Work:** #55 / PPO-009. [Policy decisions](../decisions/crm-opportunity-handover.md) · [Contract](../contracts/crm-opportunity-handover.md) · [Future proof](../testing/crm-handover-verification.md).
