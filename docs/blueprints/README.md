...
| BP-03 | [CRM Functional & Build Blueprint](BP-03-crm.md) | r01 proposed journeys/shared integration; bounded [Pipedrive parity](crm-parity.md), [synthetic screens](crm-screen-specification.md), [branded Board/Grid](crm-board-grid-mockup.html) and [implementation sequence](../delivery/crm-implementation-plan.md); account parity and acceptance remain open |
