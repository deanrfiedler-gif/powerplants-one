...
| 5 | Materiality threshold requiring attribution, per size band | Too low and close-out becomes clerical; too high and the learning is lost. On the Core band a 5% threshold is roughly $1,500 to $5,000. A single dollar threshold across a $5,000 to $10,000,000 range cannot work — it must scale with the band |
