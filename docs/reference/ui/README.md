...
| Page or workspace | Repository HTML reference | Recorded design status | Application scope and evidence |
|---|---|---|---|
| Document Register & Linked Library | [r01](document-library/PPO-Document-Register-and-Linked-Library-r01.html) · [detailed report](document-library/PPO-Document-Register-and-Linked-Library-Report-r01.md) | Proposed DK-01 / DK-02 design; owner acceptance and application integration separate | Six views cover exact document context, applicability, revision review, retained receiving references and source recovery; 23 model and 23 native-browser groups passed. [Design handover](../../decisions/document-register-linked-library-design.md), [verification](../../testing/evidence/document-library-r01/README.md). |
| Cross-module approvals & handover inbox | [r01](approvals-handover/PPO-Cross-Module-Approvals-and-Handover-Inbox-r01.html) · [detailed report](approvals-handover/PPO-Cross-Module-Approvals-and-Handover-Inbox-Report-r01.md) | Proposed SH-06; owner acceptance and application integration separate | Six queue views, exact source routing, ageing, returned submissions and domain-owned destination previews. [Handover](../../decisions/cross-module-approvals-handover-design.md) · [Verification](../../testing/evidence/approvals-handover-r01/README.md). |
...
| Deal Workspace — CR-01 | [r01](crm/PPO-Deal-Workspace-r01.html) · [detailed report](crm/PPO-Deal-Workspace-Report-r01.md) | User-authorised standalone design; owner acceptance and application integration separate | Eight views, shared Board/List preview, owned work, exact quotation evidence and recovery. [Design handover](../../decisions/deal-workspace-design.md) · [verification](../../testing/evidence/deal-workspace-r01/README.md). |
