...
| Page or workspace | Repository HTML reference | Recorded design status | Application scope and evidence |
|---|---|---|---|
| Sales-to-Delivery Handover (CR-03) | [r01](crm/PPO-Sales-to-Delivery-Handover-Workspace-r01.html) · [detailed report](crm/PPO-Sales-to-Delivery-Handover-Workspace-Report-r01.md) | Proposed CR-03 design; 25 model and 29 native browser groups passed; owner acceptance separate | Won/handover-due becomes a controlled Project, Service or parts-order acceptance with a preserved commercial basis, returned/corrected revisions and original-operation recovery. [Design and receiving handover](../../decisions/sales-delivery-handover-design.md) · [verification](../../testing/evidence/sales-delivery-handover-r01/README.md). |
