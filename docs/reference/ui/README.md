...
| Specialist Configuration Workbench | [r01](specialist/PPO-Specialist-Configuration-Workbench-r01.html) | Proposed ES-08 Screen Systems design; 25 model groups passed; native review pending | Inputs, missing definitions, reference parts, overrides, safe rerun and recovery. [Detailed report](specialist/PPO-Specialist-Configuration-Workbench-Report-r01.md) · [Handover](../../decisions/specialist-screen-systems-design.md). |
