...
| Specialist Configuration Workbench | [r01](specialist/PPO-Specialist-Configuration-Workbench-r01.html) | Proposed ES-08 Screen Systems design; 27 model and 23 native browser groups passed; captures reviewed in draft PR #210 | Inputs, missing definitions, reference parts, overrides, safe rerun and recovery. [Detailed report](specialist/PPO-Specialist-Configuration-Workbench-Report-r01.md) · [Handover](../../decisions/specialist-screen-systems-design.md). |
...
| customers | [PPO-Customers-Sites-and-Growing-Areas-Workspace-r03.html](customers/PPO-Customers-Sites-and-Growing-Areas-Workspace-r03.html) | Earlier revisions; use the latest available family reference above, subject to its recorded approval status. |
...
| equipment | [PPO-Equipment-and-Installed-Base-Workspace-r02.html](equipment/PPO-Equipment-and-Installed-Base-Workspace-r02.html) | Earlier revisions; use the latest available family reference above, subject to its recorded approval status. |
