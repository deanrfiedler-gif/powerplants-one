...
Inspection/Identification are bounded non-intervention categories: no shutdown, energised access, opening or adjustment. Intervention requires explicit conditions and applicable mandatory isolation/shutdown evidence. This is a conservative synthetic policy, not an operational safety procedure or trade competency determination.
