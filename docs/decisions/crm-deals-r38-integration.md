...
The first deployment exposed extra framing and control drift. The [authorised correction](crm-deals-design-correction.md) records Sales routes, r38/r22 authority, the host contract and required independent comparisons. Its release record supersedes earlier visual-conformance claims.
