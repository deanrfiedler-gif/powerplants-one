...
The PDF is the primary brand evidence. Navy `#242a37`, green `#62bb46` and white are source values; neutrals, semantic status colours, geometry and responsive rules are UI proposals. Use navy text on green actions. Keep the supplied alternate green-and-white logo intact on navy for the authorised private design work. Light Cloud remains unused because the PDF's RGB and HEX disagree. This does not claim company-wide brand approval.
