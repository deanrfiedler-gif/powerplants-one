...
- [Development and compiled performance profiles](ci-performance-profiles.md) — retain both original PT-27 measurements on the exact same load fixture, with bounded phase observations; r05 retains original comparisons and failures, with original comparison and deferred scope editor measurements reviewed; PR #176 now includes the exact development/compiled request-count correction and awaits refreshed source CI.
