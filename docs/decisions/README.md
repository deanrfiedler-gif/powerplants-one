...
- [Development and compiled performance profiles](ci-performance-profiles.md) — retain both original PT-27 measurements on the exact same load fixture, with bounded phase observations; original comparison reviewed and deferred closed scope editor awaiting CI.
