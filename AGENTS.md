...
For component changes, update `components.json`, the corresponding `components/*.md`, fixture/state examples, consumer bindings and alignment items in the same PR. Keep reference-only work visible and review evidence separate. Follow `docs/design/development/components/README.md`.
