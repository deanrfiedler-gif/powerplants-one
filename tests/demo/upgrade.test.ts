...
test("a baseline executed from Windows CRLF SQL upgrades without rewriting historical checksums", async () => {
  ...
  // 0018 Leads, 0019 Projects, 0020 Engineering, 0021 stages, 0022 Discovery conversion and 0023 owned outcomes and 0024 owner transfer, 0025 versioned estimating taxonomy.
  assert.equal(final.length, baseline.length + 8);
