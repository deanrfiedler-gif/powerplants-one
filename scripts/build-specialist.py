#!/usr/bin/env python3
"""Deterministic single-file Screen Systems design; no runtime dependencies."""
from pathlib import Path
import hashlib

root = Path(__file__).resolve().parents[1]
source = root / "docs/design/specialist"
target = root / "docs/reference/ui/specialist/PPO-Specialist-Configuration-Workbench-r01.html"
