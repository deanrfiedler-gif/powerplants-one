"""Build the DK-03 standalone workspace from pinned shared primitives."""
from pathlib import Path
import hashlib
import json
ROOT = Path(__file__).resolve().parents[1]
SOURCE = ROOT / 'docs/design/output-distribution'
OUTPUT = ROOT / 'docs/reference/ui/output-distribution/PPO-Output-Issue-and-Distribution-Centre-r01.html'
