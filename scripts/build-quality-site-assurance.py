#!/usr/bin/env python3
"""Build the self-contained r01 Quality, Safety and Site Assurance design."""
from pathlib import Path
import hashlib

root = Path(__file__).resolve().parents[1]
source = root / "docs/design/quality-site-assurance"
target = root / "docs/reference/ui/quality-site-assurance/PPO-Quality-Safety-and-Site-Assurance-Workspace-r01.html"
