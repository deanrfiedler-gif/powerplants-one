-- Explicit synthetic coordinator scopes only. No fabricated project or default Systems grant.
...
CROSS JOIN unnest(ARRAY['project.read','project.create','project.edit']) AS cap
