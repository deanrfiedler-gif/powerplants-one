...
export type Capability =
  ...
  | "engineering.technical.distribute"
  | "engineering.technical.source"
  | "engineering.material.review"
  | "engineering.material.release"
  | "engineering.material.receive"
  | "engineering.material.source"
  | "engineering.change.review"
  | "engineering.change.decide"
  | "engineering.change.receive"
  | "engineering.change.verify"
  | "engineering.change.close"
  | "engineering.commissioning.capture"
  | "engineering.commissioning.review"
  | "engineering.commissioning.issue"
  | "engineering.commissioning.receive"
  | "project.read"
  | "project.create"
  | "project.edit"
  | "email.read"
