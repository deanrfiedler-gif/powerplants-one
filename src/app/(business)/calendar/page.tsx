...
export default async function Page({ searchParams }: { searchParams: Promise<{ day?: string; scope?: string }> }) {
  ...
  return <EmailCalendar key={`${day}:${q.scope}`} initialDay={day} sales={q.scope === "sales"} />;
}
