...
export const reportTemplateDefinition =
  "PPO OUT-10 semantic HTML/A4 v1; customer-safe exact reviewed evidence; brand navy #242a37/green #62bb46; Roboto/Verdana fallback; escaped text; repeated identity and table headers; no external requests; no inherited signature; tagged PDF requested; stable evidence labels and compact print spacing.";
...
export async function renderReport(
  ...
  try {
    ...
    const pdf = await page.pdf({
      ...
      headerTemplate: `<div style="font:8px Roboto,Verdana,sans-serif;width:100%;margin:0 15mm;color:#242a37;overflow-wrap:anywhere">${e(s.customer.name)} · ${e(s.site.name)} · ${e(s.work.reference)}</div>`,
      footerTemplate: `<div style="font:8px Roboto,Verdana,sans-serif;width:100%;margin:0 15mm;color:#242a37">Synthetic prototype — not for operational use · ${e(s.reference)} r${String(s.revision).padStart(2, "0")} · <span class="pageNumber"></span> / <span class="totalPages"></span></div>`,
    });
