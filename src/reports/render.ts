...
export const reportTemplateDefinition =
  "PPO OUT-10 semantic HTML/A4 v1; customer-safe exact reviewed evidence; navy/green; escaped text; repeated identity and table headers; no external requests; no inherited signature; tagged PDF requested.";
