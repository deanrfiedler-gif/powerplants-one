  ...
  return sharedOperation(
    ...
    async (c, ctx) => {
      ...
      if (
        (
          await c.query(
            "SELECT to_regclass('ppo.attendance_acceptances') AS relation",
          )
        ).rows[0].relation
      ) {
