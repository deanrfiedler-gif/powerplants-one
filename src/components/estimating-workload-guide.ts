...
export const estimatingWorkloadGuide: PageGuide = {
  ...
  steps: [
    ["Find permitted work", "Search by customer, reference, title or brief. Expand Readiness, owner and sort for additional filters, then Apply filters. My estimating work selects workspaces you own, not every Sales opportunity you own. Collapsing these controls retains their selections."],
  ...
  mobile: "Search stays visible; expand Readiness, owner and sort when needed. This leaves room for workload cards on a phone. All owner, readiness, unknown-date and next-step information remains available. This page is online only; no business draft is stored on the device.",
